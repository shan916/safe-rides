...
//contains all associated ride request info: the driver, rider, and vehicle info.
public class RideRequestDto {
    ...
    public RideRequestDto(String requestorFirstName, String requestorLastName, RideRequestStatus status,
                          String estimatedTime, Date lastModified, Date assignedDate, String driverName, String vehicleColor,
                          String vehicleYear, String vehicleMake, String vehicleModel, String vehicleLicensePlate) {
    ...
    @Override
    //Returns the String format of this RideRequestDto's data.
